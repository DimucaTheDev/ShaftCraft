...
public class TravertinePieceProjectile extends Item {
    ...
    public void appendHoverText(ItemStack p_41421_, @Nullable Level p_41422_, List<Component> p_41423_, TooltipFlag p_41424_) {
        p_41423_.add(Component.translatable("tooltip.travertine_throwable1"));
        p_41423_.add(Component.translatable("tooltip.travertine_throwable2"));
        p_41423_.add(Component.translatable("tooltip.travertine_glass_break"));
        p_41423_.add(Component.translatable("tooltip.cooldown.travertine_piece"));
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_43142_, Player p_43143_, InteractionHand p_43144_) {
        ...
        p_43143_.getCooldowns().addCooldown(this.asItem(), 50);
