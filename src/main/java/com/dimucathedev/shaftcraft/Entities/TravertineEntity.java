...
public class TravertineEntity extends ThrowableItemProjectile {
    ...
    public TravertineEntity(EntityType<? extends TravertineEntity> p_37391_, Level p_37392_) {
    ...
    public TravertineEntity(Level p_37394_, double p_37395_, double p_37396_, double p_37397_) {
    ...
    protected void onHitEntity(EntityHitResult p_37259_) {
        ...
        e.hurt(DieMessages.wasKilledByStone, 5);
        kill();
    }
*/ // не работает
    ...
    public void spawnSelf(HitResult p_37260_){
        ItemEntity entity = new ItemEntity(level, p_37260_.getLocation().x,p_37260_.getLocation().y,p_37260_.getLocation().z,new ItemStack(Items.TRAVERTINE.get()));
